...
<body class="${self.body_class()}">
  ...
  <div class="container">
    ...
    ${self.footer()}
  <script src="/contrib/jquery-1.11.2.js"></script>
  <script src="${tg.url('/contrib/bootstrap.min.js')}"></script>
</body>
  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="navbar-content">
      <ul class="nav navbar-nav">
        <li class="${('', 'active')[page=='index']}"><a href="${tg.url('/area52')}">Welcome</a></li>
      </ul>
