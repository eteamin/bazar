...
model_class = h.get_model_class_by_name(model)
%>
    ...
    <div class="col-md-10">
      ...
      <div class="row">
        <div class="col-xs-3 col-md-2">
          %if not (hasattr(model_class, '__edit_only__') and model_class.__edit_only__):
            <a class="btn btn-success"
               href='${tg.url("new", params=tmpl_context.kept_params)}'>New ${model}
            </a>
          %endif
        </div>
