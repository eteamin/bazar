# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in twa.
...
from aminbazar.lib import app_globals, helpers
...
base_config.model = aminbazar.model
base_config.DBSession = aminbazar.model.DBSession
...
base_config.variable_provider = helpers.add_global_template_variables
try:
